...
public class CCWall {
    ...
    public CCVector calculateReflected(CCVector particlePositionReset,
...
//      reflected.setAzi(newAzi);
        ...
        double vDotN = particlePositionReset.dotProduct(normal);
        double twoTimesDot = 2 * vDotN;
        CCVector scaledNormal = normal.scale(twoTimesDot);
        CCVector reflected = particlePositionReset.subtract(scaledNormal);
        double partDir = particlePositionReset.getAzimuth();
